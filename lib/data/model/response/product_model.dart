...
class Product {
  ...
  String? _role1;
  double? _unitPrice;
  double? _dealerunitprice;
  double? _distributorunitprice;
  ...
  double? _dealerDiscount;
  String? _dealerDiscountType;
  double? _distributorDiscount;
  String? _distributorDiscountType;
  int? _currentStock;
  String? _details;
  String? _createdAt;
  String? _updatedAt;
  ...
  Product(
      {int? id,
        ...
        String? role,
        double? unitPrice,
        double? dealerUnitPrice,
        double? distributorUnitPrice,
        ...
        String? dealerDiscountType,
        double? distributorDiscount,
        String? distributorDiscountType,
        int? currentStock,
        String? details,
        String? attachment,
        String? createdAt,
    ...
    _dealerunitprice = dealerUnitPrice;
    _distributorunitprice = distributorUnitPrice;
    ...
    _dealerDiscount = dealerDiscount;
    _dealerDiscountType = dealerDiscountType;
    _distributorDiscount = distributorDiscount;
    _dealerDiscountType = distributorDiscountType;
  ...
  String? get role => _role1;
  double? get unitPrice => _unitPrice;
  double? get dealerUnitPrice => _dealerunitprice;
  double? get distributorUnitPrice => _distributorunitprice;
  ...
  double? get dealerDiscount => _dealerDiscount;
  String? get dealerDiscountType => _dealerDiscountType;
  double? get distributorDiscount => _distributorDiscount;
  String? get distributorDiscountType => _distributorDiscountType;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    if(json['dealer_unit_price'] != null){
      _dealerunitprice = json['dealer_unit_price'].toDouble();
    }
    if(json['distributor_unit_price'] != null){
      _distributorunitprice = json['distributor_unit_price'].toDouble();
    }
    if(json['role'] != null){
      _role1 = json['role'].toString();
    }
    ...
    if(json['dealer_discount'] != null ){
      _dealerDiscount = json['dealer_discount'].toDouble();
    }
    _dealerDiscountType = json['dealer_discount_type'];
    if(json['distributor_discount'] != null ){
      _distributorDiscount = json['distributor_discount'].toDouble();
    }
    _distributorDiscountType = json['distributor_discount_type'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['dealer_unit_price'] = _dealerunitprice;
    data['distributor_unit_price'] = _distributorunitprice;
    data['role'] = _role1;
    ...
    data['dealer_discount'] = _dealerDiscount;
    data['dealer_discount_type'] = _dealerDiscountType;
    data['distributor_discount'] = _distributorDiscount;
    data['distributor_discount_type'] = _distributorDiscountType;
