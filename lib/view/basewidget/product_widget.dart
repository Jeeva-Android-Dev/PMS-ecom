...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double? rollPrice = 0;
    double? roleDiscount = 0;
    String? roleDiscountType = " ";

    String ratting = productModel.rating != null && productModel.rating!.isNotEmpty? productModel.rating![0].average! : "0";
    if(productModel.role != null && productModel.role=="customer"){
      rollPrice = productModel.unitPrice;
    } else if(productModel.role !=null && productModel.role=="dealer"){
      rollPrice = productModel.dealerUnitPrice;
    } else if (productModel.role !=null && productModel.role=="distributor"){
      rollPrice = productModel.distributorUnitPrice;
    }
    if(productModel.role != null && productModel.role=="customer") {
      roleDiscount = productModel.discount;
      roleDiscountType = productModel .discountType;

    } else if (productModel.role != null && productModel.role=="dealer" ){
      roleDiscount = productModel.dealerDiscount;
      roleDiscountType = productModel .dealerDiscountType;

    } else if (productModel.role != null && productModel.role =="distributor"){
      roleDiscount = productModel.distributorDiscount;
      roleDiscountType = productModel .distributorDiscountType;
      ...
      child: Container(
        ...
        child: Stack(children: [
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    roleDiscount!= null && roleDiscount! > 0 ?
                    Text(PriceConverter.convertPrice(context,rollPrice),
                    ...
                    Text(PriceConverter.convertPrice(context,
                        rollPrice, discountType: roleDiscountType,
          ...
          Positioned(top: 0, left: 0, child: Container(
            ...
            child: Center(
              child: Text(PriceConverter.percentageCalculation(context, rollPrice,
                  roleDiscount, roleDiscountType),
