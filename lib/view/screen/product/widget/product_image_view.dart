...
class ProductImageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(productModel!.role != null && productModel!.role=="customer") {
      prices = productModel!.unitPrice;
    } else if (productModel!.role != null && productModel!.role=="dealer" ){
      prices = productModel!.dealerUnitPrice;

    } else if (productModel!.role != null && productModel!.role =="distributor"){
      prices = productModel!.distributorUnitPrice;
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Text(PriceConverter.percentageCalculation(context, prices,
                          rolesDiscount, rolesDiscountType),
