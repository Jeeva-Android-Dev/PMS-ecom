...
class ProductTitleView extends StatelessWidget {
  ...
  Widget build(BuildContext context)  {
    ...
    double? endingPrice;
    double? rolesDiscount = 0;
    String? rolesDiscountType= "";

    if(productModel!.role != null && productModel!.role=="customer") {
      rolesDiscount = productModel!.discount;
      rolesDiscountType = productModel !.discountType;

    } else if (productModel!.role != null && productModel!.role=="dealer" ){
      rolesDiscount = productModel!.dealerDiscount;
      rolesDiscountType = productModel !.dealerDiscountType;

    } else if (productModel!.role != null && productModel!.role =="distributor"){
      rolesDiscount = productModel!.distributorDiscount;
      rolesDiscountType = productModel !.distributorDiscountType;
    ...
    }else if(productModel!.role != null && productModel!.role=="customer") {
      startingPrice = productModel!.unitPrice;
    } else if (productModel!.role != null && productModel!.role=="dealer" ){
      startingPrice = productModel!.dealerUnitPrice;

    } else if (productModel!.role != null && productModel!.role =="distributor"){
      startingPrice = productModel!.distributorUnitPrice;
        ...
        builder: (context, details, child) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Column(children: [
                rolesDiscount!= null && rolesDiscount > 0 ?
                ...
                Text('${startingPrice != null ?PriceConverter.convertPrice(context, startingPrice,
                    discount: rolesDiscount, discountType: rolesDiscountType):''}'
                    '${endingPrice !=null ? ' - ${PriceConverter.convertPrice(context, endingPrice,
                    discount: rolesDiscount, discountType: rolesDiscountType)}' : ''}',
