...
class CartBottomSheetState extends State<CartBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    double? rolesPrices = 0;
    double? roleDiscounts = 0;
    String? roleDiscountTypes = "";
    if(widget.product!.role != null && widget.product!.role =="customer" ){
      rolesPrices = widget.product!.unitPrice;
    }else if(widget.product!.role != null && widget.product!.role =="dealer"){
      rolesPrices = widget.product!.dealerUnitPrice;
    }else if(widget.product!.role != null && widget.product!.role =="distributor"){
      rolesPrices = widget.product!.distributorUnitPrice;
    }
    if(widget.product!.role != null && widget.product!.role =="customer" ){
      roleDiscounts = widget.product!.discount;
      roleDiscountTypes = widget.product!.discountType;
    }else if(widget.product!.role != null && widget.product!.role =="dealer"){
      roleDiscounts = widget.product!.dealerDiscount;
      roleDiscountTypes = widget.product!.dealerDiscountType;
    }else if(widget.product!.role != null && widget.product!.role =="distributor"){
      roleDiscounts = widget.product!.distributorDiscount;
      roleDiscountTypes = widget.product!.distributorDiscountType;
    }
        ...
        Container(
          ...
          child: Consumer<ProductDetailsProvider>(
            builder: (ctx, details, child) {
              ...
              double priceWithDiscount = PriceConverter.convertWithDiscount(context, price, roleDiscounts, roleDiscountTypes)!;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              PriceConverter.percentageCalculation(context, rolesPrices,
                                  roleDiscounts, roleDiscountTypes),
                        ...
                        roleDiscounts> 0 ? Text(
                          PriceConverter.convertPrice(context, rolesPrices),
                          style: titilliumRegular.copyWith(color: ColorResources.getRed(context),
                              decoration: TextDecoration.lineThrough),
                        ) : const SizedBox(),
                        const SizedBox(width: Dimensions.paddingSizeDefault),
                        Text(
                          PriceConverter.convertPrice(context,rolesPrices, discountType: roleDiscountTypes, discount: roleDiscounts),
                        ...
                        onTap: stock < widget.product!.minimumOrderQty!  &&  widget.product!.productType == "physical" ? null :() {
                          if(stock! >= widget.product!.minimumOrderQty!  || widget.product!.productType == "digital") {
                            CartModel cart = CartModel(
                                ...
                                variation,roleDiscounts , roleDiscountTypes, widget.product!.tax, widget.product!.taxModel,
