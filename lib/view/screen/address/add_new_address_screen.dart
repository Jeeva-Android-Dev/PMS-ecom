...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  void initState() {
    ...
    Provider.of<LocationProvider>(context, listen: false).getRestrictedDeliveryStateList(context);
                          ...
                          child: SizedBox(
                            child: Column(
                              ...
                              children: [
                                ...
                                //mounika changed for adding state dropdown
                                const SizedBox(height: Dimensions.paddingSizeDefaultAddress),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(bottom : 8.0),
                                  child: Text(getTranslated('state', context)!,
                                    style: robotoRegular.copyWith(color: ColorResources.getHint(context)),
                                  ),
                                ),
                                Consumer<LocationProvider>(
                                  builder: (context, locationProvider, _) {
                                    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      DropdownSearch<String>(
                                        ...
                                        items: locationProvider.restrictedStateList,
                                        dropdownDecoratorProps: const DropDownDecoratorProps(
                                          dropdownSearchDecoration: InputDecoration(
                                            labelText: "state",
                                      ...
                                      Container(
                                        ...
                                        child: CountryPickerDropdown(
                                          ...
                                          itemBuilder: _buildDropdownItemForCountry,
                                          onValuePicked: (Country? country) {
                                            _stateController.text = country!.name??'';
                                          },
                                        ),
                                      ),
                                      // CountrySearchDialog(),
...
Widget _buildDropdownItemForState(Country state) => SizedBox(
    width: MediaQuery.of(Get.context!).size.width-76,
