...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    //_billdesk = Provider.of<SplashProvider>(context,listen: false).configModel!.b
  ...
  Widget build(BuildContext context) {
    ...
    List<PaymentMethod> paymentMethods = [
      ...
      if(_digitalPayment! && Provider.of<SplashProvider>(context, listen: false).configModel!.paymentMethods!.billDesk!)
        PaymentMethod('billdesk', Images.billdesk)
    ];
        ...
        children: [
          ...
          Expanded(
            child: ListView(physics: const BouncingScrollPhysics(), padding: const EdgeInsets.all(0), children: [
              ...
              // here need to add billDesk  adding by monica.
